...
<a href="{{ site.url }}{{ site.baseurl }}/Research/topics/location_share/">人と共存可能な移動ロボットシステム</a>や<a href="{{ site.url }}{{ site.baseurl }}/Research/topics/gazetrajectory/">実環境における３次元注視軌跡の解析</a>においてロボットの自己位置推定や環境地図生成をおこなうために使用しています
